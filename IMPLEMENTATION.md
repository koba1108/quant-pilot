...
- `src/pre-forward/runtime-binding.ts`: `pre-forward-runtime-binding-v2` owner-only enrollment directories that pin both physical artifact-root and ledger paths before the first decision and fail closed on missing/incomplete/legacy evidence
