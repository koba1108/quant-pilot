...
- `--replay-decision=sha256:<id>` rebuilds the canonical Decision Package from the retained exact configuration, inputs, opening state, and Universe snapshot, checks artifact and ledger binding, and applies no transition.
